...
*/				    
	...
	// Exp e1,e2;
		public void visit(Divide n) {
			...
			printInstr("pushq", new String[]{"%rax"});
			String op2 = getExpr(n.e2, false);
			printInstr("popq", new String[]{"%rbx"});
			printInstr("cqto");
			op1 = "%rbx";
			String label2 = getLabel("","L"+label_num++);
			printInstr("cmpq", new String[] {"$0", op1});
			printInstr("je", new String[] {label});
			...
			if(n.e2 instanceof IntegerLiteral) {
				...
				if (integ.i == 0) {
					printInstr("jmp", new String[] {label});
					System.out.println(label+":");
					printInstr("call", new String[] {getLabel("", "zeroDiv")});
					label = label2;
					return;
				}
				else
			...
			else if(n.e2 instanceof IdentifierExp && denominator !=null) {
					IdentifierExp id = (IdentifierExp)n.e2;
					if(denominator.equals(id.s)) {
						printInstr("jmp", new String[] {label});
						System.out.println(label+":");
						printInstr("call", new String[] {getLabel("", "zeroDiv")});
						label = label2;
